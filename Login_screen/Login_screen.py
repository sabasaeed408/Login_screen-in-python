...
class login_system:
    def __init__(self,root):
        ...
        txtuser=Entry(Login_Frame,bd=5,relief=GROOVE,font=("",15)).grid(row=2,columnspan=2,padx=20)
        ...
        txtpas=Entry(Login_Frame,bd=5,relief=GROOVE,font=("",15)).grid(row=4,columnspan=2,padx=20)
